...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    private final class Entry {
        ...
        Snapshot snapshot() throws IOException {
            ...
            return DiskLruCache.this.new Snapshot(this.key, this.sequenceNumber, sVarArr, jArr);
        }
    ...
    private void readJournal() throws IOException {
        e eVarA = l.a(this.fileSystem.source(this.journalFile));
        try {
            String strR = eVarA.r();
            String strR2 = eVarA.r();
            String strR3 = eVarA.r();
            String strR4 = eVarA.r();
            String strR5 = eVarA.r();
            if (!MAGIC.equals(strR) || !VERSION_1.equals(strR2) || !Integer.toString(this.appVersion).equals(strR3) || !Integer.toString(this.valueCount).equals(strR4) || !"".equals(strR5)) {
                throw new IOException("unexpected journal header: [" + strR + ", " + strR2 + ", " + strR4 + ", " + strR5 + "]");
            }
            int i = 0;
            while (true) {
                try {
                    readJournalLine(eVarA.r());
                    i++;
    ...
    synchronized void rebuildJournal() {
        ...
        d dVarA = l.a(this.fileSystem.sink(this.journalFileTmp));
        try {
            dVarA.b(MAGIC).i(10);
            dVarA.b(VERSION_1).i(10);
            dVarA.n(this.appVersion).i(10);
            dVarA.n(this.valueCount).i(10);
            dVarA.i(10);
