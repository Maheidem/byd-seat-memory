...
final class Hpack {
    ...
    static final class Reader {
        ...
        f readByteString() {
            ...
            return z ? f.a(Huffman.get().decode(this.source.h(i2))) : this.source.d(i2);
        }
        ...
        void readHeaders() throws IOException {
            while (!this.source.e()) {
                ...
                if ((iH & 128) == 128) {
                    readIndexedHeader(readInt(iH, 127) - 1);
                } else if (iH == 64) {
                    readLiteralHeaderWithIncrementalIndexingNewName();
                } else if ((iH & 64) == 64) {
                    readLiteralHeaderWithIncrementalIndexingIndexedName(readInt(iH, 63) - 1);
                } else if ((iH & 32) == 32) {
                    this.maxDynamicTableByteCount = readInt(iH, 31);
                    ...
                    readLiteralHeaderWithoutIndexingIndexedName(readInt(iH, 15) - 1);
                }
            }
        }
    ...
    static final class Writer {
        ...
        */
        void writeHeaders(java.util.List<okhttp3.internal.http2.Header> r14) {
            /*
