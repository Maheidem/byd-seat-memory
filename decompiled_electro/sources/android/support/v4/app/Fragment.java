...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener {
    ...
    public final FragmentManager getChildFragmentManager() throws IllegalAccessException, NoSuchFieldException, Resources.NotFoundException, IllegalArgumentException {
        if (this.mChildFragmentManager == null) {
    ...
    @CallSuper
    public void onCreate(@Nullable Bundle bundle) throws IllegalAccessException, NoSuchFieldException, Resources.NotFoundException, IllegalArgumentException {
        this.mCalled = true;
