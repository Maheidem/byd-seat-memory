...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    private Request createTunnel(int i, int i2, Request request, HttpUrl httpUrl) throws IOException {
        ...
        while (true) {
            ...
            s sVarNewFixedLengthSource = http1Codec.newFixedLengthSource(jContentLength);
            Util.skipAll(sVarNewFixedLengthSource, ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED, TimeUnit.MILLISECONDS);
            sVarNewFixedLengthSource.close();
    ...
    */
    public void connect(int r18, int r19, int r20, int r21, boolean r22, okhttp3.Call r23, okhttp3.EventListener r24) throws java.lang.Throwable {
        /*
